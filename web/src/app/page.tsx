        ...
        <div className="flex gap-5 items-stretch flex-col md:flex-row">
          <div className="flex-1 bg-gray-700 border border-gray-600 rounded-2xl p-8 space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed text-sm  md:text-base">
              ...
              criar soluções inovadoras e compartilha conhecimento. Vamos
              mergulhar nas têndencias masi recentees em desenvolvimento de
              software e arquitetura de sistemas e tecnologias emergentes, com{" "}
              <br /> <br /> Dias 15 a 17 de março | Das 18 às 21h | Online e
              Gratuito
            </p>
          </div>
